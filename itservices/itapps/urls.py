...
urlpatterns = [
    ...
    path('password_reset/', auth_views.PasswordResetView.as_view(template_name='users/password_reset_form.html'), name='password_reset_form'),
    ...
    # path('password_reset/email', user_views.password1, name='password_reset_email'),
