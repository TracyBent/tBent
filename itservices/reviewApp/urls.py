...
from . import views 
from .views import PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, UserPostListView, PostListView1, PostListView2
...
path('tablet/', PostListView2.as_view(), name='reviewApp-tablet'),
